...
# Example usage
input_csv = '../data_files/fen_cp_evaluations_20000.csv'  # Path to your input CSV file with FEN strings
output_csv = '../data_files/qs.csv'  # Path to the output CSV file
engine_path = '/usr/local/Cellar/stockfish/16/bin/stockfish'  # Path to Stockfish engine executable
